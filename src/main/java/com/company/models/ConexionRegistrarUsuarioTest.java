 ...
 * @author HP
 */
public class ConexionRegistrarUsuarioTest {
    String nombre;
    String apellido;
    String dni;
    String rol;
    ...
    public ConexionRegistrarUsuarioTest() {
    }

    public ConexionRegistrarUsuarioTest(String nombre, String apellido, String dni, String rol, String usuario, String clave) {
        this.nombre = nombre;
    ...
    public void registrarUsuarios(JTextField parametroDni, JTextField parametroNombre,JTextField parametroApellido,JComboBox parametroRol, JTextField parametroUsuario, JTextField parametroClave){
        ...
        String consulta="insert into centrovacunacion.usuarios (dniUsuario,nombreUsuario,apellidoUsuario,rolUsuario,claveUsuario,IdUsuario)"
                + "values"+"(?, ?, ?, ?, ?, ?)";
        try {
    ...
    public void seleccionarUsuario(JTable paramTableUser,JTextField paramDni,JTextField paramNombre,JTextField paramApellido,JComboBox paramRol,JTextField paramUsuario, JTextField paramClave){
        try {
            ...
            if(fila>=0){
                ...
                paramRol.setSelectedItem(paramTableUser.getValueAt(fila, 3).toString());
                paramClave.setText(paramTableUser.getValueAt(fila, 5).toString());
                paramUsuario.setText(paramTableUser.getValueAt(fila, 4).toString());
            }else{
