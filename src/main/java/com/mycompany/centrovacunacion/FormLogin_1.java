 ...
 * @author HP
 */
public class FormLogin_1 extends javax.swing.JFrame {
...
//        objetoConexion.estableceConexion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLogin_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLogin_1().setVisible(true);
            }
        });
    }
