 ...
 * @author HP
 */
public class FormRegistrarVacuna_1 extends javax.swing.JFrame {

    /**
     * Creates new form FormRegistrarVacuna
     */
    public FormRegistrarVacuna_1() {
        initComponents();
...
//        objetoALumnos.seleccionarAlumno(tbTotalVacunasDisponibles, txtId, txtNombres, txtApellidos, txtEspecialidad, txtPromocion);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRegistrarVacuna_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormRegistrarVacuna_1().setVisible(true);
            }
        });
    }
